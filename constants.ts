...
export const TIMELINE_EVENTS: TimelineEvent[] = [
  ...
  { 
    id: 't-nov-1', date: '06 Nov 2025', status: 'completed',
    items: [{ division: 'Kepanitiaan', target: 'Pembentukan Struktur', focus: 'Penetapan struktur dan pemilihan ketua pelaksana.' }]
  },
  { 
    id: 't-nov-2', date: '12 Nov 2025', status: 'completed',
    items: [{ division: 'Kepanitiaan', target: 'Rapat Perdana', focus: 'Konsolidasi awal seluruh panitia DN KMH LOTIM.' }]
  },
  { 
    id: 't-nov-3', date: '27 Nov 2025', status: 'completed',
    items: [{ division: 'Kepanitiaan', target: 'Rapat Besar I', focus: 'Pembahasan konsep dan pengenalan DN KMH.' }]
  },
  { 
    id: 't-dec-1', date: '04 Des 2025', status: 'completed',
    items: [{ division: 'Kepanitiaan', target: 'Rapat Besar II', focus: 'Penetapan tema dan pembahasan rundown, serta penetapan talent.' }]
  },
  { 
    id: 't-dec-2', date: '27 Des 2025', status: 'completed',
    items: [{ division: 'Acara', target: 'Latihan Talent', focus: 'Masih latihan kasar.' }]
  },
  
  // --- JANUARI 2026 ---
  { 
    id: 't-jan-1', date: '10 Jan 2026', status: 'completed',
    items: [{ division: 'Acara', target: 'Latihan Talent & Rapat', focus: 'Latihan kasar dan rapat inti terkait dies natalis.' }]
  },
  { 
    id: 't-jan-12-18', 
    date: '12 - 18 Januari 2026', 
    status: 'ongoing',
    items: [
        {
            division: 'Divisi Acara',
            target: 'Latihan 2x (Rumah & Tugu)',
            focus: 'Tari: 60%\nDirigen: 60%\nMc formal: 60%\nPresean: 50%\nMc non formal: 50%'
        },
        {
            division: 'Divisi Media',
        ...
        {
            division: 'Divisi Humas',
            target: 'Minimal 50% progres awal',
            focus: 'Menghubungi media partner dan sponsor secara online, pengantaran proposal.'
        }
    ]
  },
  { 
    id: 't-jan-19-25', 
    date: '19 - 25 Januari 2026', 
    status: 'upcoming',
    items: [
        {
            division: 'Divisi Acara',
        ...
        {
            division: 'Divisi Humas',
            target: 'Progres humas 70%',
            focus: 'Pemasukan surat dan follow up sponsor serta media partner.'
        },
        {
            division: 'Divisi Media',
            target: 'Materi promosi utama siap',
            focus: 'Pembuatan feed Instagram dan konten promosi Seminar Hukum Nasional.'
        }
    ]
  },
  { 
    id: 't-jan-26-end', 
    date: '26 Jan - 1 Feb 2026', 
    status: 'upcoming',
    items: [
        {
            division: 'Divisi Acara',
            target: 'Latihan 3x & Persiapan Seminar',
            focus: 'Tari: 100%\nDirigen: 100%\nMc formal: 100%\nPresean: 70%\nMc non formal: 70%'
        },
        {
            division: 'Divisi Humas',
  ...
  // --- NEW: RAPAT BESAR III ---
  { 
    id: 't-jan-31-rb3', date: '31 Januari 2026', status: 'upcoming',
    items: [{ division: 'RAPAT PENTING (LOTIM)', target: 'Rapat Besar III', focus: 'Evaluasi kinerja menyeluruh dan pemantapan teknis menjelang rangkaian acara Februari.' }]
  },

  // --- FEBRUARI 2026 ---
  { 
    id: 't-feb-2-8', 
    date: '2 - 8 Februari 2026', 
    status: 'upcoming',
    items: [
        {
            division: 'Divisi Acara',
        ...
        {
            division: 'Divisi Media',
            target: 'Kebutuhan visual acara siap',
            focus: 'Editing ID card dan lanyard serta pendampingan latihan talent.'
        }
    ]
  },
  
  // --- EVENT: SEMINAR HUKUM (Highlight) ---
  { 
    id: 't-feb-4-sem', date: '4 Februari 2026', status: 'upcoming',
    items: [{ division: 'EVENT UTAMA', target: 'Seminar Hukum Nasional', focus: 'Diskusi panel dengan pemateri ahli di Lombok Timur.' }]
  },

  { 
    id: 't-feb-9-15', 
    date: '9 - 15 Februari 2026', 
    status: 'upcoming',
    items: [
        {
            division: 'Divisi Acara',
            target: 'Latihan Terakhir di Lotim',
  ...
  // --- EVENT: SANTUNAN (Highlight) ---
  { 
    id: 't-mar-ramadan', date: 'Pertengahan Ramadan 2026', status: 'upcoming',
    items: [{ division: 'KEGIATAN SOSIAL', target: 'Santunan Panti Asuhan', focus: 'Buka bersama dan penyerahan bantuan sosial.' }]
  },

  // --- EVENT: LOMBA INFOGRAFIS (Highlight) ---
  { 
    id: 't-mar-lomba', date: 'Maret 2026', status: 'upcoming',
    items: [{ division: 'KOMPETISI', target: 'Lomba Desain Infografis', focus: 'Perlombaan kreatifitas digital tingkat umum.' }]
  },

  // --- MARET AKHIR (Libur & Kumpul) ---
  { 
    id: 't-mar-15-22', 
  ...
  // --- PUNCAK ACARA ---
  { 
    id: 't-puncak', date: '1 April 2026', status: 'upcoming',
    items: [{ division: 'MAIN EVENT', target: 'Malam Puncak Dies Natalis', focus: 'Perayaan puncak, pentas seni, dan seremonial penutup.' }]
  },
];